...
GO
/*
The type for column EmployeeID in table [dbo].[Employee] is currently  NVARCHAR (50) NOT NULL but is being changed to  INT NOT NULL. Data loss could occur.
*/
...
GO
ALTER TABLE [dbo].[Employee] ALTER COLUMN [EmployeeID] INT NOT NULL;
